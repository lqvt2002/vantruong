    ...
    <body>
        <header class="header">
            ...
            <ul class="header-col">
                ...
                <li class="header-item"><a href="register.php" style="color: rgb(8, 8, 8); text-decoration: none;">ĐĂNG KÝ</a></li>
            </ul>
        </header>
        <div class="container1">
            <div class="container" style="margin-top:40px; width:600px;">
                <form action="" method="POST" onsubmit="return validateForm();" style="border: 1px solid black;  border-radius: 10px; padding:15px; background-color: white; ">
                    <h1 style=" margin:10px; text-align:center;">ĐĂNG NHẬP TÀI KHOẢN</h1>
                    ...
                    <button type="submit" class="btn btn-default" style="background-image: url(../../assets/image/background_header.png);">Đăng nhập</button>
                    <p style="text-align: left">  <a href="#" >Quên mật khẩu?</a> hoặc <a href="register.php" >Đăng ký tài khoản.</a>
                     </p>
                </form>
            </div>
        </div>
